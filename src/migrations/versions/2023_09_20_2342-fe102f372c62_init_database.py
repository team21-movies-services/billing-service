...
def upgrade() -> None:
    ...
    op.create_table('pay_systems',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(length=127), nullable=False, comment='Название платёжной системы'),
    sa.Column('alias', sa.String(length=127), nullable=False, comment='Алиас для обращения в коде'),
    sa.Column('currency_code', sa.String(length=8), nullable=False, comment='Валюта по умолчанию'),
    sa.Column('json_data', postgresql.JSONB(astext_type=sa.Text()), server_default='{}', nullable=False, comment='Доп. данные платежной системы'),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('period_unit', postgresql.ENUM('day', 'month', 'year', name='tariff_period_unit'), nullable=True, comment='Единица измерения периода (месяц, день, год)'),
    sa.Column('json_sale', postgresql.JSONB(astext_type=sa.Text()), server_default='{}', nullable=False, comment='Скидки на тариф'),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('json_sale', postgresql.JSONB(astext_type=sa.Text()), server_default='{}', nullable=False, comment='Детали платежа (request/response)'),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('user_id', sa.UUID(), nullable=False, comment='ID пользователя'),
    sa.Column('period_start', postgresql.TIMESTAMP(), nullable=False, comment='Дата и время начала действия подписки'),
    sa.Column('period_end', postgresql.TIMESTAMP(), nullable=False, comment='Дата и время окончания действия подписки'),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
